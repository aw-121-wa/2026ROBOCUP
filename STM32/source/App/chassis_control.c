...
static uint8_t telemetry[144]; /* Existing 27 + 8 task/link channels + JustFloat tail. */
#else
static uint8_t telemetry[124]; /* Existing 22 + 8 task/link channels + JustFloat tail. */
#endif
#endif
